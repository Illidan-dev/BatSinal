...
export default function BatForm({onSubmit}: BatFormProps){
    ...
    const submit = () => {
        ...
        const all_ok        = Object.values(all_fields).every( v => v );
            ...
            alert(`${nome}, Apartir de agora, em algumas noites você verá o Bat-Sinal projetado ao Céu`);
            onSubmit();
    }
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.formGroup}>
                ...
                <TextInput style={styles.input} onChangeText={setTelefone} keyboardType="phone-pad" />
            </View>
            ...
            <View style={styles.formGroup}>
                ...
                <TextInput style={styles.input} keyboardType="number-pad" onChangeText={setIdade} />
            </View>
